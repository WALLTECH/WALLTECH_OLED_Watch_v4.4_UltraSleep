 ...
 *     \|____________|\|__|\|__|\|_______|\|_______|\|__|  \|_______|\|_______|\|__|\|__|
 *
 * This is the default code for the Walltech OLED Watch v4.4
 *
 * Designed specifically to work with the Walltech OLED Watch v4.4:
...
void setup() {
  ...
  delay(1000);
  oled.setCursor(7, 57);
  oled.print(F("v4.4 John Wall 2015"));
  oled.display();
  delay(1000);
  oled.clearDisplay();
